...
import com.food.ordering.system.restaurant.service.domain.order.service.domain.ports.output.repository.message.publisher.payment.OrderCreatedPaymentRequestMessagePublisher;
...
public class OrderCreateHelper {
    ...
    @Transactional
    public OrderCreatedEvent persistOrder(CreateOrderCommand createOrderCommand, DomainEventPublisher<OrderCreatedEvent> orderCreatedEventDomainEventPublisher)
    {
    ...
    private Restaurant checkRestaurant(CreateOrderCommand createOrderCommand) {
        ...
        if (optionalRestaurant.isEmpty()) {
            ...
            throw new OrderDomainException("Could not restaurant with restaurant id" + createOrderCommand.getRestaurantId());
        }
