package com.food.ordering.system.restautant.service.domain.order.service.domain.mapper;

import com.food.ordering.system.restautant.service.domain.domain.valueobject.CustomerId;
import com.food.ordering.system.restautant.service.domain.domain.valueobject.Money;
import com.food.ordering.system.restautant.service.domain.domain.valueobject.ProductId;
import com.food.ordering.system.restautant.service.domain.domain.valueobject.RestaurantId;
...
public class OrderDataMapper {
    public Restaurant createOrderCommandToRestaurant(CreateOrderCommand createOrderCommand) {
        return Restaurant.builder()
                ...
                .products(createOrderCommand.getItems().stream().map(orderItem ->
                                new Product(new ProductId(UUID.randomUUID())))
    ...
    private List<OrderItem> orderItemsToOrderItemEntities(
            List<com.food.ordering.system.restautant.service.domain.order.service.domain.dto.create.OrderItem> orderItems) {
